...
- **Docs, or any file in general**: for anything meant to stick around, a fresh-context Haiku read-back is a cheap option worth taking: "Without any other context, can you follow this document? Does it exist, does it cover X/Y/Z, any broken sentences or gaps, which sentence has two possible readings?" Rewrite any sentence with two readings until it only has one.
